...
Figure 3 depicts one mean-head dropout block. This release preserves both mean-head dropout modules in the supplied training implementation rather than changing the numerical model to match the drawing.
